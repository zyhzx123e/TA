...
public partial class Master_pages_main : System.Web.UI.MasterPage
{
    protected void Page_Load(object sender, EventArgs e)
    {
       ...
       string indication ="Number of Applications : " + Application["TotalApplications"] + "  || " + "Number of Users Online : " + Application["TotalUserSessions"];
    ...
    protected void indication(object sender,EventArgs e)
    {
        string indication = "Number of Users Online : " + Application["TotalUserSessions"];
        Literal li = new Literal();
        li.Text = indication;
        place_indication.Controls.Add(li);
    }
