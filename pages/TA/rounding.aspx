<%@ Page Title="Rounding" Language="C#" MasterPageFile="~/Master pages/main.master" AutoEventWireup="true" CodeFile="rounding.aspx.cs" Inherits="pages_TA_rounding" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="pageContent" Runat="Server">
       ...
       <div class="row">
            <div class="col-lg-7">
                <asp:Button ID="add_new_problem" CssClass="btn btn-default" Text="Add a problem" runat="server" OnClick="add_new_problem_Click" OnCommand="add_new_problem_Command" />
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
        ...
        <asp:Panel ID="add_new_problem_panel" runat="server" CssClass="popForm" style ='display:none' align="center" >      
            ...
            <div class="form-group form-inline">
                <asp:Label Text="PC Number" runat="server"></asp:Label>
                <asp:TextBox ID="pc_number" CssClass="form-control" runat="server"></asp:TextBox>
            </div>
            ...
            <div class="form-group form-inline">
                <asp:Label ID="addProblemLabel" runat="server"></asp:Label>
            </div>
        </asp:Panel>
