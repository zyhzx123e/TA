<%@ Page Title="" Language="C#" MasterPageFile="~/Master pages/main.master" AutoEventWireup="true" CodeFile="Generated Roster.aspx.cs" Inherits="pages_scheduler_Generated_Roster" %>
        ...
        <div class="row">
            <div class="col-md-12 table-responsive">
                ...
                <div class="form-group">
                    <asp:Button ID="draftBtn" Text="Generate Draft"  CssClass="btn btn-info" runat="server" Enabled="false" OnClick="draftBtn_Click" />
                    <asp:Button ID="finalBtn" Text="Generate Final"  CssClass="btn btn-success" runat="server" Enabled="false" OnClick="finalBtn_Click" />
